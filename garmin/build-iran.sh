...
mv output/gmapsupp.img output/Waldrian_TOPO_${countryname_short}_garmin.img
#./src/jmc_cli -src=output -dest=output -bmap=${countryname_short}.img -gmap="iran.gmap"

#DATE=`date +%s`
#mkdir -p output/${countryname_short}

#mv output/${countryname_short}.img output/iran/iran_${DATE}.img
#mv output/${countryname_short}.gmap output/iran/iran_${DATE}.gmap
